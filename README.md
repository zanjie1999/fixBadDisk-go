# 一键 u盘/内存卡/硬盘 坏块/坏道 维修工具 防作弊测速工具 Golang重构
[原Python3项目](https://github.com/zanjie1999/fixBadDisk)  
使用Golang重写，1.7M单文件，无需任何依赖，支持任意系统  
...
可以在 [这里](https://github.com/zanjie1999/fixBadDisk-go/releases) 下载你对应的操作系统和架构的二进制文件，放到需要检测的盘直接点开运行  
